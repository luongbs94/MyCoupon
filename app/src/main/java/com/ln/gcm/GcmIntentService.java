...
public class GcmIntentService extends IntentService {
    ...
    private void registerGCM() {
        ...
        try {
            ...
            sharedPreferences.edit().putBoolean(MainApplication.SENT_TOKEN_TO_SERVER, true).apply();
        } catch (Exception e) {
            Log.e(TAG, "Failed to complete token refresh", e);

            sharedPreferences.edit().putBoolean(MainApplication.SENT_TOKEN_TO_SERVER, false).apply();
        }
