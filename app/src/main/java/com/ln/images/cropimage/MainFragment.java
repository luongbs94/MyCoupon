...
public class MainFragment extends Fragment {
    ...
    public static MainFragment getInstance(String path) {
        MainFragment fragment = new MainFragment();
        Bundle args = new Bundle();
        args.putString(MainApplication.LINK_IMAGES, path);
...
//        mCropView.setDebug(true);
        ...
        String path = getArguments().getString(MainApplication.LINK_IMAGES);
